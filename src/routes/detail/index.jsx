...
import { Card, Icon, List, NavBar } from "antd-mobile"; //有了react-app-rewired，此处会按需加载组件的js和css代码
import { API_GET_HOSPITAL_BY_ID, get } from "../../utils/api";
import copy from "copy-to-clipboard";
import { copyToClickBoard } from "../../utils/util.js";
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <i className="ai-phone" onClick={() => copyToClickBoard(hospital.mobile, "联系方式")} />
                      </td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>
                        <i className="ai-home" onClick={() => copyToClickBoard(hospital.street, "医院地址")} />
                      </td>
                    </tr>
                  </tbody>
                </table>
